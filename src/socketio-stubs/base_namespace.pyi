...
class BaseServerNamespace(BaseNamespace):
    server: BaseServer[Any] | None
    def __init__(self, namespace: str | None = ...) -> None: ...
    def rooms(self, sid: str, namespace: str | None = ...) -> Incomplete: ...
    def _set_server(self, server: BaseServer[Any]) -> None: ...

class BaseClientNamespace(BaseNamespace):
    client: BaseClient[Any, Any] | None
    def __init__(self, namespace: str | None = ...) -> None: ...
    def _set_client(self, client: BaseClient[Any, Any]) -> None: ...
